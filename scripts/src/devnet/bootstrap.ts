...
bind_addr = "${process.env.SOLVENT_BIND_ADDR ?? "0.0.0.0:8080"}"
rpc_url = "${process.env.SOLVENT_RPC_URL ?? "http://127.0.0.1:8545"}"
...
default_fee_bps = 5
block_explorer_url = "${process.env.SOLVENT_EXPLORER_URL ?? "http://localhost:5100"}"
faucet = true
...
[[chains]]
chain_id = ${manifest.chain_id}
name = "${process.env.SOLVENT_CHAIN_NAME ?? "Solvent Devnet"}"
